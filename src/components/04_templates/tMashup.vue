<template>
  <div class="mashup-container">
    ...
    <oMashupEditor :mashup="mashup" :mashupTds="mashupTds" :tds="tds" />
  </div>
</template>
...
export default Vue.extend({
  ...
  created() {
    ...
    this.mashup = (this as any).getSidebarElement({
  ...
  computed: {
    ...
    getDescription(): null | string {
      return this.mashup && this.mashup.description
        ? this.mashup.description
        : null;
    },
  },
  watch: {
